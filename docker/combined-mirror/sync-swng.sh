...
RSYNC_SOURCE="${SWNG_RSYNC_SOURCE:-rsync://rsync.upstream.cloudlinux.com/SWNG/}"
MIRROR_PATH="${SWNG_MIRROR_PATH:-/var/www/mirrors/swng}"
LOG_FILE="${SWNG_LOG_FILE:-/var/log/swng-mirror.log}"
